...
int ff_raw_video_read_header(AVFormatContext *s)
{
    ...
    // NETINT the assignment below sets avg_frame_rate to 25 which remains unchanged/not-retrieved
    // in subsequent stream info finding and causes incorrect fps displayed/used later; comment this
    // out for now so correct fps can be retrieved; this needs to be watched for any side effect
    // st->avg_frame_rate = s1->framerate;

    // NETINT: assign default framerate to avctx in case stream has no timing info
