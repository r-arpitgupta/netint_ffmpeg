...
int enc_open(void *opaque, const AVFrame *frame)
{
    ...
    case AVMEDIA_TYPE_VIDEO: {
        ...
        // NETINT: automatically enable xcoder-params=GenHdrs for MKV/HLS/ASF/FLV containers
        if (!strcmp(of->format->name, "matroska") ||
            !strcmp(of->format->name, "hls") ||
            !strcmp(of->format->name, "asf") ||
            !strcmp(of->format->name, "flv")) {
            AVDictionaryEntry *t;
            if ((t = av_dict_get(ost->encoder_opts, "xcoder-params", NULL, 0))) {
                ...
                av_opt_set(enc_ctx->priv_data, "xcoder-params", "GenHdrs=1", 0);
            }
        }
